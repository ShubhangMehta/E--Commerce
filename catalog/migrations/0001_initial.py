    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_order', models.PositiveSmallIntegerField(blank=True, help_text='Position in homepage banner (1–3)', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_type', models.CharField(choices=[('product', 'Product Image'), ('banner', 'Banner Image')], default='product', max_length=10)),
